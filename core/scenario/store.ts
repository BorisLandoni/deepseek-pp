...
const BUILT_IN_SCENARIOS: ScenarioConfig[] = [
  { id: 'summarize', label: 'Summarise', template: 'Please summarise the following content concisely:\n\n{text}', builtIn: true, enabled: true },
  { id: 'explain', label: 'Explain', template: 'Please explain the following content:\n\n{text}', builtIn: true, enabled: true },
  { id: 'translate', label: 'Translate', template: 'Please translate the following content to English:\n\n{text}', builtIn: true, enabled: true },
];
