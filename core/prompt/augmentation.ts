...
function renderWebSearchGuidance(descriptors: readonly ToolDescriptor[]): string {
  ...
  return [
    '## Web Search Rules',
    '',
    'Use the web_search tool to search the internet when the conversation involves any of the following:',
    '- The user asks about real-time information, news, events, exchange rates, weather, etc.',
    '- The user asks about knowledge you are uncertain of and the latest information needs to be consulted',
    '- The user explicitly asks you to search or look up certain information',
    '- You need to verify facts, data, or cite sources',
    '',
    '### Search process',
    '1. First emit a web_search tool call to perform the search',
    '2. The search will execute automatically; results will be displayed on the page and returned to you',
    '3. After reading the search results, provide your answer based on those results',
    '',
    '### Example',
    '',
    'User: Who won the 2024 Nobel Prize?',
    'Assistant reply:',
    '',
    ...
    '',
    '### Rules',
    '- Use relevant keywords in the language of the user\'s question for better results',
    '- If one search is not enough, continue calling web_search with different keywords',
    '- Do not fabricate real-time information without searching first',
  ].join('\n');
}
